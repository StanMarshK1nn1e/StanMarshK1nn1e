$\color{#505E32}{♧-"Hello ~ whoever ~ is ~ reading ~ this" -♧}$

$\color{#FFFFFF}{So, ~ this ~ is ~ basically ~ for~personal ~ or ~ game ~ purposes, ~ but ~ who ~ cares.}$

$\color{#FFFFFF}{Well, ~ I'm ~ pretty ~ much ~ gonna ~ go ~ on ~ about ~ how ~ I ~ act ~ most ~ of ~ the ~ time, ~ how ~ to ~ personally ~ deal ~ with ~ me ~ ig}$
$\color{#FFFFFF}{and ~ how ~ my ~ personality ~ is ~ like.}$



$\color{#505E32}{So, ~ here ~ I ~ am ~ with ~ you ~ and ~ yes, ~ YOU ~ as ~ a ~ reader ~ :D}$
...
$\color{#FFFFFF}{For ~ you ~ who ~ is ~ reading ~ right ~ now, ~ just}$
$\color{#FFFFFF}{know ~ sometimes ~ my ~ texts ~ don't ~ seem ~ as ~ playful ~ or}$
...
$\color{#FFFFFF}{If ~ you ~ do ~ that ~ often, ~ then ~ I ~ could ~ pretty ~ much}$
$\color{#FFFFFF}{say ~ I ~ will ~ highly ~ respect ~ you ~ for ~ it ~ because}$
...
$\color{#FFFFFF}{I ~ also ~ appreciate ~ anyone ~ who ~ gives ~ facts ~ about}$
$\color{#FFFFFF}{type ~ of ~ argument ~ or ~ fight ~ so ~ I ~ can ~ clarify ~ what}$
...
$\color{#FFFFFF}{confront ~ them ~ face ~ to ~ face.}$
$\color{#FFFFFF}{Why? ~ Because ~ I ~ value ~ pivacy, ~ comfort, ~ and ~ good}$
$\color{#FFFFFF}{treatment ~ for ~ anybody.}$

$\color{#3B636B}{Since ~ I'm ~ done ~ with ~ some ~ key ~ points, ~ let's}$
$\color{#3B636B}{move ~ on ~ to ~ the ~ next ~ one.}$
